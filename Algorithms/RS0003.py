...
from Quantopian.algorithm import Algo, AllocationModel
...
def define_transforms(context):   # Define transforms
    ...
    context.transforms = [
        ...
        Transform(context, name='smma', function=Transform.simple_mean_monthly_average, inputs=['price'],
                  kwargs={'lookback': 3}, outputs=['smma']),
...
def initialize(context):
    ...
    rs0003 = StrategyParameters(context,
                                name='rs0003',
...
result.to_pickle('E:\\NOTEBOOKS\\Quantopian\\Strategies\\rs0003F.pkl')
